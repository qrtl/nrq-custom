...
class TestHrTimesheetSheet(common.TransactionCase):
    ...
    def test_compute_works_hours(self):
        ...
        self.assertEqual(self.test_timesheet_sheet.standard_work_hours, 40.0, "The Standard Hours did not match the value")
        ...
        # Check Holiday Hours
        self.assertEqual(self.test_timesheet_sheet.holiday_hours, 8, "The Holiday Hours did not match the value")

        # Check Expected Hours
        self.assertEqual(self.test_timesheet_sheet.expected_work_hours, self.test_timesheet_sheet.standard_work_hours-self.test_timesheet_sheet.holiday_hours, "The Expected Hours did not match the value")
        ...
        self.assertEqual(self.test_timesheet_sheet.overtime_hours, self.test_timesheet_sheet.total_timesheet - self.test_timesheet_sheet.expected_work_hours, "The Overtime Hours did not match the value")
